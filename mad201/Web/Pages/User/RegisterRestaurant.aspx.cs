...
{
    public partial class RegisterRestaurant : SpecificCulturePage
    {
        ...
        protected void BtnRegisterClick(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    UserSummaryDto userProfileDetailsVO =
                        new UserSummaryDto(txtLogin.Text, txtRestaurantName.Text, txtAddress.Text,
                            txtEmail.Text, comboLanguage.SelectedValue,
                            comboCountry.SelectedValue, "Restaurant");

                    SessionManager.RegisterRestaurant(Context, txtLogin.Text,
                        txtPassword.Text, userProfileDetailsVO, txtSchedule.Text, txtRestaurantType.Text);
                ...
                {
                    lblRestaurantNameError.Visible = true;
                }
            }
        }
