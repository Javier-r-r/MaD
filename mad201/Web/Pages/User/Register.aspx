<%@ Page Title="" Language="C#" MasterPageFile="~/Mad201.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Web.Pages.User.Register" %>
    ...
    <div id="form">
        <form id="RegisterForm" method="post" runat="server">
            ...
            <div class="field">
                <span class="label">
                    <asp:Localize ID="lclSurname" runat="server" meta:resourcekey="lclSurname" /></span><span
                        class="entry">
                        <asp:TextBox ID="txtSurname" runat="server" Width="100px"
                            Columns="16" meta:resourcekey="txtSurnameResource1"></asp:TextBox>
            ...
            <div style="text-align: center; margin-top: 40px;">
                <div>
                    <asp:Button ID="btnRegister" runat="server" CssClass="custom-btn" OnClick="BtnRegisterClick" meta:resourcekey="btnRegister" />
                </div>
                <div>
