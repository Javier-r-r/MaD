            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    UserSummaryDto userProfileDetailsVO =
                        new UserSummaryDto(txtLogin.Text, txtFirstName.Text, txtAddress.Text,
                            txtEmail.Text, comboLanguage.SelectedValue,
                            comboCountry.SelectedValue, "Client");

                    SessionManager.RegisterUser(Context, txtLogin.Text,
                        txtPassword.Text, userProfileDetailsVO, txtSurname.Text);
