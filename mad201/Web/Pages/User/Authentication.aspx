<%@ Page Title="" Language="C#" MasterPageFile="~/Mad201.Master" AutoEventWireup="true" 
    CodeBehind="Authentication.aspx.cs" Inherits="Web.Pages.User.Authentication" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_BodyContent"
    ...
    <div id="form">
        <form id="AuthenticationForm" method="POST" runat="server">
            ...
            <div class="button">
                <asp:Button ID="btnLogin" runat="server" CssClass="custom-btn" OnClick="BtnLoginClick" meta:resourcekey="btnLogin" />
            </div>
            <div>
