<%@ Page Title="" Language="C#" MasterPageFile="~/Mad201.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Web.Pages.Restaurants.AddProduct" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_BodyContent" runat="server">
    <h2>
        <asp:Localize ID="lclAddProductTitle" runat="server" meta:resourcekey="lclAddProductTitle" />
    </h2>
    ...
    <div id="form">
        <form id="AddProductForm" method="post" runat="server">
            ...
            <div class="field">
                ...
                <span class="entry">
                    <asp:DropDownList ID="ddlCategory" runat="server" Width="150px" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" AutoPostBack="True" meta:resourcekey="ddlCategory" />
            ...
            <div class="field" id="propertyList" runat="server" visible="false">
                <h4>
